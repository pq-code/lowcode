    ...
    const batchDelete = async () => {
      ...
      try {
        ...
        try {
          ...
          if (result.success) {
            ElMessage.success(result.message || `成功删除物料`);
            // 清空选中
            selectedMaterials.value = [];
            // 重新加载列表
            await loadMaterials(currentGroup.value);
      ...
      <div class="material-content">
        <div class="material-toolbar">
          ...
          <div class="material-actions">
            <el-button type="primary" icon={Plus} onClick={createMaterial}>新建物料</el-button>
            <el-button type="info" icon={Upload} onClick={importMaterials}>导入物料</el-button>
          </div>
        </div>
